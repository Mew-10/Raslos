package net.benjamin.raslos.block.custom;

import net.benjamin.raslos.container.FireImbuerContainer;
import net.benjamin.raslos.tileentity.FireImbuerTile;
import net.benjamin.raslos.tileentity.ModTileEntities;
...
public class FireImbuerBlock extends Block
{
    ...
    public FireImbuerBlock(Properties properties)
    {
        super(properties);
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit)
    {
        if(!worldIn.isRemote())
        {
            ...
            if(tileEntity instanceof FireImbuerTile)
            {
                INamedContainerProvider containerProvider = new INamedContainerProvider()
                {
                    ...
                    {
                        return new TranslationTextComponent("screen.raslos.fire_imbuer");
                    }

                    @Override
                    public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity)
                    {
                        return new FireImbuerContainer(i, worldIn, pos, playerInventory, playerEntity);
                    }
                };
    ...
    {
        return ModTileEntities.FIRE_IMBUER_TILE_ENTITY.get().create();
    }
